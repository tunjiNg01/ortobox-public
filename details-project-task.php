                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive" data-toggle="lists" data-lists-sort-by="js-lists-values-employee-name" data-lists-values='["js-lists-values-employee-name", "js-lists-values-employer-name", "js-lists-values-projects", "js-lists-values-activity", "js-lists-values-earnings"]'>
                                ...
                                <div class="card card--raised">
                                    ...
                                    <table class="table mb-0 thead-border-top-0 table-nowrap">
                                        <thead>
                                            <tr>
                                                <th scope="col" colspan="4">Project Task Details</th>
                                            </tr>
                                        </thead>
                                        <tbody >
                                            <tr>
                                                <th scope="row">Project Task Name</th>
                                                <td style="text-align: left"></td>
                                                <th scope="row">Project Task No</th>
                                                <td style="text-align: left"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th scope="row">Project Task Number Id</th>
                                                <td style="text-align: left"></td>
                                            ...
                                            <tr>
                                                <th scope="row">Share with users </th>
                                                <td style="text-align: left"></td>
                                            ...
                                            <tr>
                                                ...
                                                <th scope="row">Project milestones</th>
                                                <td style="text-align: left"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Related Task</th>
                                                <td style="text-align: left"></td>
                            ...
                            <div class="card card--raised">
                                    ...
                                    <table class="table mb-0 thead-border-top-0 table-nowrap">
                                        <thead>
                                            <tr>
                                                <th scope="col" colspan="4">Custom Information</th>
                                            </tr>
                                        </thead>
                                        <tbody >
                                            <tr>
                                            ...
                                            <tr>
                                                <th scope="row">Target End Date</th>
                                                <td style="text-align: left"></td>
                                                <th scope="row">End Date</th>
                                                <td style="text-align: left"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Estimated work time</th>
                                                <td style="text-align: left"></td>
                                                <th scope="row"></th>
                                                <td style="text-align: left;"></td>
                                            </tr>
                            ...
                            <div class="card card--raised">
                                    ...
                                    <table class="table mb-0 thead-border-top-0 table-nowrap">
                                        <thead>
                                            <tr>
                                                <th scope="col" colspan="4">Description Details</th>
                                            </tr>
                                        </thead>
                                        <tbody >
                                            <tr>
