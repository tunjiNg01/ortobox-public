        ...
        if (isset($_GET['view']) && $_GET['view'] == 'edit'): 
            include 'edit-project-task.php';
        elseif ( isset($_GET['view']) && $_GET['view'] == 'details' && isset($_GET['record']) ):
            include 'details-project-task.php';
        else: ?>
            <div class="border-bottom-2 py-32pt position-relative z-1">
                <div class="container-fluid page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                            <h2 class="mb-0">Projects Task</h2>
                    ...
                    <div class="row" role="tablist">
                        ...
                        <div class="col-auto border-left">
                            <a href="?module=projects&p=project-task&view=edit" class="btn btn-accent">New Task</a>
                        </div>
                    </div>
                ...
                <div class="page-section">
                    ...
                    <div class="card dashboard-area-tabs mb-32pt">
                        ...
                        <div class="table-responsive" data-toggle="lists" data-lists-sort-by="js-lists-values-date" data-lists-sort-desc="true" data-lists-values='["js-lists-values-lead", "js-lists-values-project", "js-lists-values-status", "js-lists-values-assign", "js-lists-values-date", "js-lists-values-relate"]'>
                            ...
                            <table class="table mb-0 thead-border-top-0 table-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th><a href="javascript:void(0)" class="sort" data-sort="js-lists-values-project">Project Task Name</a></th>

                                        <th ><a href="javascript:void(0)" class="sort" data-sort="js-lists-values-relate">Related To</a></th>


                                        <th><a href="javascript:void(0)" class="sort" data-sort="js-lists-values-lead">Priority</a></th>


                                        <th > <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-status">Progress</a> </th>

                                        <th >
                                            <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-date">Start Date</a>
                                        </th>

                                        <th >
                                            <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-date">End Date</a>
                                        </th>
                                        <th >
                                            <a href="javascript:void(0)" class="sort" data-sort="js-lists-values-assign">Assigned To</a>
                                        </th>
                                        <th ></th>
                                    </tr>
                                </thead>
                                <tbody class="list" id="projects">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="?module=projects&p=project-task&view=details&record=12">
                                                ...
                                                <div class="media flex-nowrap align-items-center" style="white-space: nowrap;">
                                                    ...
                                                    <div class="media-body">
                                                        <div class="d-flex flex-column">
                                                            <small class="js-lists-values-relate"><strong>Social Media API</strong></small>
                                        ...
                                        <td>
                                            <a href="?module=projects&p=project-task&view=details&record=12">
                                                <div class="d-flex flex-column">
                                                     <small class="js-lists-values-assign"><strong>&dollar;1,200</strong></small>
